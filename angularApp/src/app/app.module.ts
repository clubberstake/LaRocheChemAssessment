...
import { CourseAssessmentUpdateUserComponent } from './admin/course-assessment-update-user/course-assessment-update-user.component';
...
@NgModule({
  declarations: [
    ...
    CourseAssessmentUpdateUserComponent
  ],
